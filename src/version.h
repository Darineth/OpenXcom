...
#define OPENXCOM_VERSION_DX "0.11.0"
#define OPENXCOM_VERSION_NUMBER_DX 0,11,0,0

// Compact display (UI - main menu, titles, loading): "Extended DX 0.11.0". Kept short on purpose;
...
// headers): "Extended DX 0.11.0 (OXCE 8.6.2)".
