...
enum VoxelType : int { V_EMPTY = -1, V_FLOOR, V_WESTWALL, V_NORTHWALL, V_OBJECT, V_UNIT, V_OUTOFBOUNDS, V_UNITTARGETHIT, V_TILETARGETHIT, V_UNITTARGETOBSTRUCTED, V_TILETARGETOBSTRUCTED };
