...
public:
	...
	void setDefaultLayout(const std::vector<EquipmentLayoutItem*> &layout, const std::string &armorColor);
	/// Gets the default equipment layout for this role.
	std::vector<EquipmentLayoutItem*> getDefaultLayout() const;
	/// Gets the default armor color for this role.
	const std::string &getDefaultArmorColor() const;
