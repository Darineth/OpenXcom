...
// this should probably be any small screen touch-device, i don't know the defines for all of them so i'll cover android and IOS as i imagine they're more common
	...
	_info.push_back(OptionInfo("removeWoundedFromTraining", &removeWoundedFromTraining, true, "STR_REMOVE_WOUNDED_FROM_TRAINING", "STR_GEOSCAPE"));
	...
	_info.push_back(OptionInfo("strafe", &strafe, true, "STR_STRAFE", "STR_BATTLESCAPE"));
	...
	_info.push_back(OptionInfo("keyBattleUseUtility", &keyBattleUseUtility, SDLK_z, "STR_USE_UTILITY", "STR_BATTLESCAPE"));
